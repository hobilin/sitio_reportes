...
var compareDateWithStartDayHour = function(startDate, endDate, startDayHour, allDay) {
    ...
    var result = startDate.getHours() >= startTime.hours && startDate.getMinutes() >= startTime.minutes || endDate.getHours() >= startTime.hours && endDate.getMinutes() >= startTime.minutes || allDay;
    return result
};
