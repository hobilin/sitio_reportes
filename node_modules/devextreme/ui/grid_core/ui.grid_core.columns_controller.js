    ...
    controllers: {
        columns: modules.Controller.inherit(function() {
            ...
            var createColumn = function(that, columnOptions, userStateColumnOptions, bandColumn) {
                ...
                if (columnOptions) {
                    ...
                    if (columnOptions.command) {
                        ...
                        }, DEFAULT_COLUMN_OPTIONS, commonColumnOptions, calculatedColumnOptions, columnOptions, {
                            selector: null
                        })
                    }
                }
            ...
            var processExpandColumns = function(columns, expandColumns, type, columnIndex) {
                ...
                if (rowspan > 1) {
                    expandColumnsByType = iteratorUtils.map(expandColumnsByType, function(expandColumn) {
                                ...
                                parseValue: function(text) {
                                    ...
                                    if ("number" === column.dataType) {
                                        if (typeUtils.isString(text) && column.format) {
                                            ...
                                            if (isDefined(text) && typeUtils.isNumeric(text)) {
                                                result = Number(text)
                                            }
                                        }
                                    } else {
