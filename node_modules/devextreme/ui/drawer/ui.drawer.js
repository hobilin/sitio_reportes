...
var Drawer = _ui2.default.inherit({
    ...
    _orderContent: function(position) {
        if (this._needOrderContent() && ("right" === position || "bottom" === position)) {
            this._$wrapper.prepend(this._$contentWrapper)
        } else {
            this._$wrapper.prepend(this._$panel)
        }
    },
    _needOrderContent: function() {
        return "push" !== this.option("openedStateMode")
    },
    ...
    getDrawerPosition: function() {
        var resultPosition = this.option("position");
        var rtl = this.option("rtlEnabled");
        if (this.isHorizontalDirection() && rtl) {
            return "right" === resultPosition ? "left" : "right"
        }
        return resultPosition
    },
    isHorizontalDirection: function() {
        return "left" === this.option("position") || "right" === this.option("position")
    },
    ...
    _refreshPanel: function() {
        ...
        this._whenPanelRefreshed.always(function() {
