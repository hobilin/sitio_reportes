...
var DrawerStrategy = function() {
    ...
    _createClass(DrawerStrategy, [{
        ...
        value: function(offset, animate) {
            var _this = this;
            this._drawer._animations.push(new Promise(function(resolve) {
                _this._contentAnimationResolve = resolve
            }));
            this._drawer._animations.push(new Promise(function(resolve) {
                _this._panelAnimationResolve = resolve
            }));
            this._drawer._animations.push(new Promise(function(resolve) {
                _this._shaderAnimationResolve = resolve
            }));
            if (animate) {
                Promise.all(this._drawer._animations).then(function() {
        ...
        value: function(offset, animate, duration) {
            ...
            if (animate) {
                animation.fade((0, _renderer2.default)(drawer._$shader), fadeConfig, duration, function() {
                    ...
                    _this2._shaderAnimationResolve()
                })
            } else {
        ...
        value: function(keepMaxSize) {
            ...
            if (drawer.isHorizontalDirection()) {
                (0, _renderer2.default)(drawer.content()).css("width", keepMaxSize ? drawer.getRealPanelWidth() : panelSize)
            } else {
                (0, _renderer2.default)(drawer.content()).css("height", keepMaxSize ? drawer.getRealPanelHeight() : panelSize)
            }
        }
    }]);
