...
var DropImageModule = function(_BaseModule) {
    ...
    function DropImageModule(quill, options) {
        ...
        _events_engine2.default.on(_this.quill.root, _utils2.default.addNamespace("dragover", widgetName), _this._dragOverHandler.bind(_this));
        _events_engine2.default.on(_this.quill.root, _utils2.default.addNamespace("drop", widgetName), _this._dropHandler.bind(_this));
        _events_engine2.default.on(_this.quill.root, _utils2.default.addNamespace("paste", widgetName), _this._pasteHandler.bind(_this));
        return _this
    }
