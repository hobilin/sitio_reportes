...
Axis.prototype = {
    ...
    _getVisualRangeUpdateMode: function(range, newRange) {
        ...
        if ([SHIFT, KEEP, RESET].indexOf(value) === -1) {
            if (range.axisType === _axes_constants2.default.discrete) {
                if (range.categories && newRange.categories && newRange.categories.every(function(c, i) {
                        return c === range.categories[i]
                    })) {
                    value = KEEP
                } else {
                    value = RESET
    ...
    _handleBusinessRangeChanged: function(seriesData) {
        var currentBusinessRange = new _range2.default.Range(this._translator.getBusinessRange());
        ...
        var that = this;
        var options = that._options;
        var visualRangeUpdateMode = this._getVisualRangeUpdateMode(currentBusinessRange, seriesData);
        ...
        if (visualRangeUpdateMode === SHIFT) {
            var _currentBusinessRange = this._translator.getBusinessRange();
            var length = void 0;
            if (options.type === _axes_constants2.default.logarithmic) {
                length = (0, _math2.adjust)(_utils2.default.getLog(_currentBusinessRange.maxVisible / _currentBusinessRange.minVisible, options.logarithmBase))
            } else {
                if (options.type === _axes_constants2.default.discrete) {
                    var categoriesInfo = _utils2.default.getCategoriesInfo(_currentBusinessRange.categories, _currentBusinessRange.minVisible, _currentBusinessRange.maxVisible);
                    length = categoriesInfo.categories.length
                } else {
                    length = _currentBusinessRange.maxVisible - _currentBusinessRange.minVisible
                }
            }
    ...
    getZoomEndEventArg: function(currentRange) {
    ...
    setCustomVisualRange: function(value) {
    ...
    handleZooming: function(visualRange, preventEvents) {
        var that = this;
        preventEvents = preventEvents || {};
        visualRange = that._validateVisualRange(visualRange);
        var zoomStartEvent = that.getZoomStartEventArg();
        var currentRange = preventEvents.startRange && that._validateVisualRange(preventEvents.startRange) || zoomStartEvent.range;
        ...
        if (!zoomStartEvent.cancel) {
            ...
            var zoomEndEvent = that.getZoomEndEventArg(currentRange);
