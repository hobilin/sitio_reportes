...
var Scheduler = Widget.inherit({
    _getDefaultOptions: function() {
        var _extend;
        return extend(this.callBase(), (_extend = {
            views: ["day", "week"],
            currentView: "day",
        ...
        }, _defineProperty(_extend, "groupByDate", false), _defineProperty(_extend, "allowMultipleCellSelection", true), _defineProperty(_extend, "_appointmentTooltipOffset", {
            x: 0,
            y: 0
        }), _defineProperty(_extend, "_appointmentTooltipButtonsPosition", "bottom"), _defineProperty(_extend, "_appointmentTooltipCloseButton", false), _defineProperty(_extend, "_useAppointmentColorForTooltip", false), _defineProperty(_extend, "_appointmentTooltipOpenButtonText", messageLocalization.format("dxScheduler-openAppointment")), _defineProperty(_extend, "_appointmentTooltipOpenButtonIcon", ""), _defineProperty(_extend, "_dropDownButtonIcon", "overflow"), _defineProperty(_extend, "_appointmentCountPerCell", 2), _defineProperty(_extend, "_appointmentGroupButtonOffset", 0), _defineProperty(_extend, "_appointmentOffset", 26), _extend))
    },
